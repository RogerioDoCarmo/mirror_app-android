...
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="d7173e31-1f63-5ded-8df4-515fe5e3a0e9")}catch(e){}}();
const e=require(`./chunk-gGpyby2o.cjs`),t=require(`./turbosnap-C-4jyyaH.cjs`),n=require(`./meow-BJmmmeH9.cjs`),r=require(`./log--I3rdIPg.cjs`),i=require(`./readStatsFile-CwBmK3gM.cjs`);var a=e.a(n.t());const{STORYBOOK_BASE_DIR:o,STORYBOOK_CONFIG_DIR:s,WEBPACK_STATS_FILE:c}=process.env;async function l(e){let{flags:n,input:l}=(0,a.default)(`
    Usage
    ...
    `,{argv:e,description:`Trace utility for TurboSnap`,flags:{statsFile:{type:`string`,alias:`s`,default:c||`storybook-static/preview-stats.json`},storybookBaseDir:{type:`string`,alias:`b`,default:o||`.`},storybookConfigDir:{type:`string`,alias:`c`,default:s||`.storybook`},untraced:{type:`string`,alias:`u`,isMultiple:!0},mode:{type:`string`,alias:`m`}}}),u=r.t({},{logPrefix:``,logLevel:`info`}),d={log:u,options:{storybookBaseDir:n.storybookBaseDir,storybookConfigDir:n.storybookConfigDir,untraced:n.untraced,traceChanged:n.mode||!0},git:{rootPath:await t.H({log:u})},storybook:{baseDir:n.storybookBaseDir,configDir:n.storybookConfigDir}},f=await i.t(n.statsFile),p=l.map(e=>e.replace(/^\.\//,``)),m=p.find(e=>t.u(e));if(m)throw Error(`Unable to trace package manifest file (${m}) as that would require diffing file contents.`);await t.n(d,f,n.statsFile,p)}exports.main=l;
//# sourceMappingURL=trace-BdDO7eJ0.cjs.map
//# debugId=d7173e31-1f63-5ded-8df4-515fe5e3a0e9
